...
{
    public class StoreDbContextData
    {
        public static async Task CargarDataAsync(StoreDbContext context, ILoggerFactory loggerFactory)
        {
            try
            {
            ...
            {
                var logger = loggerFactory.CreateLogger<StoreDbContextData>();
